...
<html>
    <head>
        ...
        <link rel="stylesheet" href="static/css/pendding.css">
        <link rel="stylesheet" href="static/css/Advertiesment.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <form id="addForm">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="name">Shop Name:</label>
                                            ...
                                            <input class=" form-control" type="text" id="shopName" readonly="" required="">
                                ...
                                <div class="row" id="spec">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="modelName" readonly="" required="">
                                    </div>
                                    <div class="col-md-9">
                                        <div class="row" id="mainCategoryForm-buttonSet">

                                            <div class="col-md-2">
                                                <button type="submit" class="btn btn-danger" id="btn-remove">Remove</button>
                                            </div>
                            ...
                            <div class="box-body">
                                <div class="row" >
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="text-align: center">Shop Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="text-align: center" aria-label="Browser: activate to sort column ascending">Brand Name</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="text-align: center" aria-label="Browser: activate to sort column ascending">Price</th>
        ...
        <script src="static/js/Advertiesment.js"></script>
