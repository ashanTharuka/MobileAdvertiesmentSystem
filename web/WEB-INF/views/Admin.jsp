...
<%@page import="edu.ijse.mobileadvertiesmentsystem.dto.AdminDTO"%>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="#" id="woow" class="btn btn-default btn-flat">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row" >
                                ...
                                <div class="col-md-4">
                                    <img src="static/img/userLogIn.png" class="img-responsive" width="100px" style="margin:0 auto" >
                                    <form id="adminForm" >
                                        <div class="form-group">
                                            <input type="text" value="  <%=id%>" style="display: none" id="id"  name="adminId">
                                            <label for="adminName">Amin Name:</label>
                                            <input type="text" value="  <%=name%>" class="form-control"id="name" name="adminName" pattern="[a-zA-Z ]*$" required >
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Amin Email</label>
                                            <input type="email" class="form-control"id="email" value="  <%=email%>"  name="email" required >
                                        </div>
                                        <div class="form-group">
                                            <label for="pwd">Password</label>
                                            <input type="password" class="form-control collectes-ville text-center" id="password1" placeholder="Enter password" required="">
                                        </div>
                                        <div class="form-group">
