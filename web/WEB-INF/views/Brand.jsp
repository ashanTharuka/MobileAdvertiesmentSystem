                                    ...
                                    <form id="specificationTypeForm">
                                        ...
                                        <div class="row" id="spec">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control typeahead" id="name"  pattern="[a-zA-Z ]*$" required>
                                                </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="row" id="mainCategoryForm-buttonSet">
                                                    ...
                                                    <div class="col-md-2">
                                                        <button type="submit" data-toggle="tooltip" title="you can delete Brand from particular MainCategory" data-placement="top"  class="btn btn-primary" id="btn-delete">Delete</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row" id="specification-table">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Brand Id</th>
