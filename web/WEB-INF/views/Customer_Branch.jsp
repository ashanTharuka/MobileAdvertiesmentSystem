...
<html>
    <head>
        ...
        <link rel="stylesheet" href="static/css/cus_branch.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <div class="box-body"  id="specificationTypeForm">
                                    ...
                                    <form id="branchForm">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" value="${shop}" id="shopname" name="shopName" readonly="">
                                            </div>
                                        </div>
                                        <hr> 
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div id="the-basics">
                                                    <input type="text" class="form-control typeahead"  id="city" name="add1" required="" width="300px">
                                                </div> 
                                            </div> 
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control"  id="tel1" name="add1" required="">
                                            </div> 
                                            <div class="col-md-3">
                                                <label for="name">Tel 2</label>
                                                <input type="text" class="form-control"  id="tel2" name="add1" required="">
                                            </div> 

                                            <!--<div class="col-md-3"></div>-->
                                            <div class="col-md-2">
                                                <button type="submit"  class="btn btn-primary" id="add-btn" style="width: 90px; margin-top:24px">Add</button>
                                            </div>
                                            <div class="col-md-2">
                                                <button type="submit"  class="btn btn-primary" id="update-btn" style="width: 90px; margin-top:24px">Update</button>
                                            </div>
                                            <div class="col-md-2">
                                                <button type="submit"  class="btn btn-primary" id="delete-btn" style="width: 90px; margin-top:24px">Delete</button>
                                            </div>
                            ...
                            <div class="row" id="specification-table" style="margin-top:40px">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Branch Id</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Tel 1 </th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Tel 2</th>
        ...
        <script src="static/js/cus_branch.js"></script>
