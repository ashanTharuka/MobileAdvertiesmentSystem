...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Specification Type</li>
                    </ol>
                </section>
                                    ...
                                    <form id="specificationTypeForm">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div id="the-basics">
                                                    <input class="typeahead form-control" type="text" placeholder="select mainCategory" id="mname">
                                                </div>
                                        ...
                                        <div class="row" id="spec">
                                            <div class="col-md-3">
                                                <label for="name">SpecificationType Name:</label>
                            ...
                            <div class="row" id="specification-table">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Specification-Type Id</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Specification-Type Name</th>
        ...
        <script src="static/js/specificationtype.js"></script>
