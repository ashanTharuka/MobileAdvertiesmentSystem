...
<html>
    <head>
        ...
        <link rel="stylesheet" href="static/css/specification.css">
                        ...
                        <div class="box-body">
                            <div class="row" >
                                <div class="col-md-12">
                                    ...
                                    <form id="specification-sub">
                                        <input type="text" id="id" name="id"  style="display: none" >
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="name">SpecificationType: </label>
                                                <input type="text" class="form-control typeahead" id="specType"   readonly="">
                                            </div> 
                                            <div class="col-md-1"></div>
                                            <div class="col-md-4">
                                                <label for="name">Specification Description: </label>
                                                <input type="text" class="form-control typeahead" id="specdesc" placeholder="enter description"  required="" >
                                            </div>
                                            <div class="col-md-2" >
                                                <button type="submit" class="btn btn-primary" id="btn-update" style="margin-top:24px" >Update </button>
                                            </div>
                                        </div>
                            ...
                            <div class="row" id="specification-table">
                                <div class="box-body" style="margin-top:20px;">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Specification Id</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Specification Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Specification Description</th>
